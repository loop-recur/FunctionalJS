;(function (window, undefined) {
  // Pattern for detecting multiple module loading schemes
  // (i.e. CommonJS, AMD, etc..) is attributed to lodash.js 
  // <http://lodash.com>
  ...
  oldFunctional = window._;

  // Reverts the "_" variable to its previous value and returns a 
  // reference to the "functional" function.
  // @returns {Function} the "functional" function.
  // @example
  //   var functional = _.noConflict();
  functional.noConflict = function noConflict() {
    window._ = oldFunctional;
    return this;
  }
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    // Define an anonymous module so that, through path mapping, it can
    // be referenced as the "underscore" module.
  ...
  // an "exports" object.
    ...
    if (typeof module == 'object' && module && module.exports == freeExports) {
      (module.exports = functional)._ = functional;
    }
    // Narwhal or RingoJS v0.7.0-
    else {
      freeExports._ = functional;
    }
  }
